...
if(carla_autoware_agent_CONFIG_INCLUDED)
  return()
endif()
set(carla_autoware_agent_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(carla_autoware_agent_SOURCE_PREFIX /home/autoware/carla_ws/src/carla-autoware-agent)
  set(carla_autoware_agent_DEVEL_PREFIX /home/autoware/carla_ws/devel)
  set(carla_autoware_agent_INSTALL_PREFIX "")
  set(carla_autoware_agent_PREFIX ${carla_autoware_agent_DEVEL_PREFIX})
else()
  set(carla_autoware_agent_SOURCE_PREFIX "")
  set(carla_autoware_agent_DEVEL_PREFIX "")
  set(carla_autoware_agent_INSTALL_PREFIX /home/autoware/carla_ws/install)
  set(carla_autoware_agent_PREFIX ${carla_autoware_agent_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'carla_autoware_agent' is deprecated")
...
set(carla_autoware_agent_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(carla_autoware_agent_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${carla_autoware_agent_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'carla_autoware_agent' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'carla_autoware_agent' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/autoware/carla_ws/src/carla-autoware-agent/${idir}'.  ${_report}")
    endif()
    _list_append_unique(carla_autoware_agent_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND carla_autoware_agent_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND carla_autoware_agent_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT carla_autoware_agent_NUM_DUMMY_TARGETS)
      set(carla_autoware_agent_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::carla_autoware_agent::wrapped-linker-option${carla_autoware_agent_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR carla_autoware_agent_NUM_DUMMY_TARGETS "${carla_autoware_agent_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::carla_autoware_agent::wrapped-linker-option${carla_autoware_agent_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND carla_autoware_agent_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(carla_autoware_agent_LIBRARY_DIRS ${lib_path})
      list(APPEND carla_autoware_agent_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'carla_autoware_agent'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND carla_autoware_agent_LIBRARIES ${lib})
    endif()
  endif()
...
set(carla_autoware_agent_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${carla_autoware_agent_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 carla_autoware_agent_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${carla_autoware_agent_dep}_FOUND)
      find_package(${carla_autoware_agent_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${carla_autoware_agent_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(carla_autoware_agent_INCLUDE_DIRS ${${carla_autoware_agent_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(carla_autoware_agent_LIBRARIES ${carla_autoware_agent_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${carla_autoware_agent_dep}_LIBRARIES})
  _list_append_deduplicate(carla_autoware_agent_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(carla_autoware_agent_LIBRARIES ${carla_autoware_agent_LIBRARIES})

  _list_append_unique(carla_autoware_agent_LIBRARY_DIRS ${${carla_autoware_agent_dep}_LIBRARY_DIRS})
  list(APPEND carla_autoware_agent_EXPORTED_TARGETS ${${carla_autoware_agent_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${carla_autoware_agent_DIR}/${extra})
  endif()
  include(${extra})
endforeach()

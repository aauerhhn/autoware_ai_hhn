...
echo_and_run cd "/home/autoware/carla_ws/src/ros-bridge/carla_infrastructure"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/autoware/carla_ws/src/ros-bridge/carla_infrastructure/setup.py" \
     \
    build --build-base "/home/autoware/carla_ws/build/ros-bridge/carla_infrastructure" \
    install \
    --root="${DESTDIR-/}" \

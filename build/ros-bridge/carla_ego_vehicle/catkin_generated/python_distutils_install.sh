...
echo_and_run cd "/home/autoware/carla_ws/src/ros-bridge/carla_ego_vehicle"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/autoware/carla_ws/src/ros-bridge/carla_ego_vehicle/setup.py" \
     \
    build --build-base "/home/autoware/carla_ws/build/ros-bridge/carla_ego_vehicle" \
    install \
    --root="${DESTDIR-/}" \

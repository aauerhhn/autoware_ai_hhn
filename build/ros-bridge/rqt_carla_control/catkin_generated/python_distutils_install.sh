...
echo_and_run cd "/home/autoware/carla_ws/src/ros-bridge/rqt_carla_control"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/autoware/carla_ws/src/ros-bridge/rqt_carla_control/setup.py" \
     \
    build --build-base "/home/autoware/carla_ws/build/ros-bridge/rqt_carla_control" \
    install \
    --root="${DESTDIR-/}" \
